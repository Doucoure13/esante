...
<section class="content home">
    <div class="container-fluid">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#income"><i class="zmdi zmdi zmdi-case-download"></i> <span>Rapport de revenu</span></a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#sales"><i class="zmdi zmdi-file-text"></i> <span>Rapport des ventes</span></a></li>
        </ul> 
            ...
            <div role="tabpanel" class="tab-pane active in" id="income">
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="info-box-3 bg-green">
                            ...
                            <div class="content">
                                <div class="text">Revenu total</div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="info-box-3 bg-blush">
                            ...
                            <div class="content">
                                <div class="text">Des patients uniques</div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="info-box-3 bg-blue">
                            ...
                            <div class="content">
                                <div class="text">Revenu mensuel</div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="info-box-3 bg-blue-grey">
                            ...
                            <div class="content">
                                <div class="text">Bénéfice net</div>
                ...
                <div class="row clearfix">
                    <div class="col-sm-12 col-md-12 col-lg-4">
                        <div class="card">
                            <div class="header">
                                <h2>Analyse du revenu<small >18% de plus que le mois dernier</small></h2>
                                <ul class="header-dropdown">
                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="javascript:void(0);">Action</a></li>

@extends('/layouts/masters2',['title'=>'Accueil'])
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">Chiffre d'affaire de l'Hôpital</div>
                        <div class="number">1.800.000 Fcfa</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>Nouveau Patient <small >18% de plus que le mois dernier</small></h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu float-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>Opérations cardiaques <small>18% de plus que le mois dernier</small></h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu float-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>Traitement médical <small>18% de plus que le mois dernier</small></h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu float-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> Liste des Nouveaux patients <small>Description text...</small> </h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu float-right">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <ul class="country-state">
                            <li class="m-b-20">
                                <h4 class="m-b-0">6350</h4> <small>De l'Inde</small>
                            ...
                            <li class="m-b-20">
                                <h4 class="m-b-0">3250</h4> <small>Des Émirats Arabes Unis</small>
                            ...
                            <li class="m-b-20">
                                <h4 class="m-b-0">1250</h4> <small>De Australie</small>
                            ...
                            <li  class="m-b-20">
                                <h4 class="m-b-0">1350</h4> <small>Des USA</small>
                                <div class="float-right">70%</div>
                                <div class="progress">
                            ...
                            <li>
                                <h4 class="m-b-0">1250</h4> <small>Du Royaume-Uni</small>
